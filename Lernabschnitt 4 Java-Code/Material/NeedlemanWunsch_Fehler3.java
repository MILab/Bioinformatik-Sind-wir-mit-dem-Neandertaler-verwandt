 ...
 * @version 2.0
 */
	public class NeedlemanWunsch_Fehler3 {
        ...
        void initialisiere_bewertungs_matrix() {
            ...
            for (int reihe = 0; reihe <= mSeqA.length; reihe++) {
                    for (int spalte = 0; spalte <= mSeqB.length; spalte++) {
                            if ((reihe == 0)&&(spalte!=0)) {
                                    bewertungs_matrix[reihe][spalte] = 4+bewertungs_matrix[reihe][spalte-1]+luecke;
                            } else if ((spalte == 0)&&(reihe!=0)) {
                                    bewertungs_matrix[reihe][spalte] = 0+bewertungs_matrix[reihe-1][spalte]+luecke;
                            } else {
        ...
        public static void main(String [] args) {     
                NeedlemanWunsch_Fehler3 nw = new NeedlemanWunsch_Fehler3();
