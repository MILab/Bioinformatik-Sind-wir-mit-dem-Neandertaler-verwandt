 ...
 */
	public class NeedlemanWunsch_Fehler2 {
        ...
        private void zwischenergebnisse_berechnen(int spalte, int reihe) {
              ...
              lueckeA = bewertungs_matrix[reihe-1][spalte] +luecke;
        ...
        void initialisiere_bewertungs_matrix() {
            ...
            for (int reihe = 0; reihe <= mSeqA.length; reihe++) {
                    for (int spalte = 0; spalte <= mSeqB.length; spalte++) {
                            if ((reihe == 0)&&(spalte!=0)) {
                                    bewertungs_matrix[reihe][spalte] = 0+bewertungs_matrix[reihe][spalte-1]+luecke;
                            } else if ((spalte == 0)&&(reihe!=0)) {
                                    bewertungs_matrix[reihe][spalte] = 1+bewertungs_matrix[reihe-1][spalte]+luecke;
                            } else {
        ...
        public static void main(String [] args) {     
                NeedlemanWunsch_Fehler2 nw = new NeedlemanWunsch_Fehler2();
