  ...
  public class NeedlemanWunsch {
        ...
        private void zwischenergebnisse_berechnen(int spalte, int reihe) {
            gleich = bewertungs_matrix[reihe-1][spalte-1] + vergleiche(reihe, spalte);
              lueckeA = bewertungs_matrix[reihe][spalte-1] +lücke;
              lueckeB = bewertungs_matrix[reihe-1][spalte] +lücke;      
    }
    ...
    void backtracking() {
                ...
                while (reihe > 0 && spalte > 0) {  
                    ...
                    int lueckeA = bewertungs_matrix[reihe][spalte-1] +lücke;
                        int lueckeB = bewertungs_matrix[reihe-1][spalte] +lücke;
        ...
        void initialisiere_bewertungs_matrix() {
            ...
            for (int reihe = 0; reihe <= mSeqA.length; reihe++) {
                    for (int spalte = 0; spalte <= mSeqB.length; spalte++) {
                            if ((reihe == 0)&&(spalte!=0)) {
                                    bewertungs_matrix[reihe][spalte] = bewertungs_matrix[reihe][spalte-1]+lücke;
                            } else if ((spalte == 0)&&(reihe!=0)) {
                                    bewertungs_matrix[reihe][spalte] = bewertungs_matrix[reihe-1][spalte]+lücke;
                            } else {
