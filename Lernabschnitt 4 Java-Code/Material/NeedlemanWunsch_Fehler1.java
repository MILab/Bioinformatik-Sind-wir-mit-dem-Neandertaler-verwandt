 ...
 * @version 2.0
 */
	public class NeedlemanWunsch_Fehler1 {
        ...
        void initialisiere_bewertungs_matrix() {
            ...
            for (int reihe = 0; reihe <= mSeqA.length; reihe++) {
                    for (int spalte = 0; spalte <= mSeqB.length; spalte++) {
                            if ((reihe == 0)&&(spalte!=0)) {
                                    bewertungs_matrix[reihe][spalte] = -2*bewertungs_matrix[reihe][spalte-1]+luecke;
        ...
        public static void main(String [] args) {     
                NeedlemanWunsch_Fehler1 nw = new NeedlemanWunsch_Fehler1();
